...
<body>
    <div>
        ...
        <form action="${pageContext.request.contextPath}/LoginServlet" method="post"> <!--submits login form data to LoginServlet-->
        ...
        <%
            ...
            {
        %>
                <p class="error-message"><%= error %></p> <!--displays error message if login fails-->
        <%
            }
        %>
